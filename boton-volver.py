...
ARCHIVOS = [
    ...
    Path("modulo-5-enfermedades-infecciosas/index.html"),
    Path("modulo-6-calculadora-rc/index.html"),
    Path("modulo-7-casos-ecicep/index.html"),
    Path("juego-solemne2/index.html"),
]
